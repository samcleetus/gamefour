...
#images
save_img = pygame.image.load('./assets/img_4/save_btn.png')
yes_img = pygame.image.load('./assets/img_4/yes_btn.png')
no_img = pygame.image.load('./assets/img_4/no_btn.png')
load_img = pygame.image.load('./assets/img_4/load_btn.png')
...
while run:
    ...
    if load_button.draw(screen):
        ...
        try:
            ...
            draw_text("Level does not exist yet", font, red, 10, 10)
